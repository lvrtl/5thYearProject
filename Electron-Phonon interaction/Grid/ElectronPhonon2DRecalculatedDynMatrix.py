...
class lattice:
    ...
    def EigSolve(self):
        eigenvals, vectors = sparse.linalg.eigsh(self.DynamicalMatrixSparce,
                                                 k = len(self.points)*2.5,
                                                 ncv = len(self.points)*5,
                                                 which = 'SM')
...
if __name__ == "__main__":
    ...
    latticeDims = [10,10]
    lattice.GridData(latticeDims,[1,1],12)
    BC = None
...
#    Grid.EigSolve()
    ...
    Grid.sigma = 0.1
    r = [5,5,5]
    Grid.X0 = [latticeDims[0]/2,latticeDims[1]/2,0]
    ...
    plt.title("10 by 10 grid structure")
...
#    graph_path = ImgDir+'\\'+'ElectronPhononInteraction' + str(Grid.sigma) + '.svg'
